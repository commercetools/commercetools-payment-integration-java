 ...
 */
public class PayoneIDealTest extends BasePayoneTest {

    @Before
    public void setup() throws ExecutionException, InterruptedException {
        super.setup(1, CountryCode.NL);// payment is only available in Niederlands
    }
    ...
    public void createPaymentCreationMethod() throws ExecutionException, InterruptedException {
        ...
        String reference = generateTestPayoneReference("ideal-test");
        PaymentCreationResult paymentCreationResult = PaymentAdapterService.of()
                .createPayment(CreatePaymentDataBuilder.of(
                        ...
                        .configValue(BANK_GROUP_TYPE, "ING_BANK")
                        .build())
