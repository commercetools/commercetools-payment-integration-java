...
import static com.commercetools.payment.payone.config.PayonePaymentMethodKeys.WALLET_PAYDIREKT;
 ...
 */
public class PayonePaydirektTest extends BasePayoneTest {
    ...
    public void testPaymentFlow() throws ExecutionException, InterruptedException {
        ...
        String reference = generateTestPayoneReference("paydirekt-test");
