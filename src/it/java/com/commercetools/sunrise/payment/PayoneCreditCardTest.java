...
public class PayoneCreditCardTest {
    ...
    public void createPaymentCreationMethod() throws ExecutionException, InterruptedException {
        ...
        PaymentCreationResult paymentCreationResult = PaymentAdapterService.of().createPayment("PAYONE", "CREDIT_CARD", CreatePaymentDataBuilder.of(client, cart).build()).toCompletableFuture().get();
